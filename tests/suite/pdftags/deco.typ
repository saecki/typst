--- deco-tags-underline pdftags(ua-1) ---
...
--- deco-tags-different-color pdftags(ua-1) ---
#show: underline.with(stroke: red)
red underlined text
#show: underline.with(stroke: blue)
blue underlined text

--- deco-tags-different-stroke-thickness pdftags(ua-1) ---
#show: underline.with(stroke: 2pt)
thick underlined
#show: underline.with(stroke: 1pt)
thin underlined

--- deco-tags-different-type pdftags(ua-1) ---
#underline[underlined]\
#overline[overlined]\
#strike[striked]\

--- deco-tags-multiple-styles pdftags(ua-1) ---
#show: underline
// Error: 2-16 PDF/UA-1 error: cannot combine underline, overline, or strike
#show: overline
text with a bunch of lines

--- deco-tags-highlight-basic pdftags(ua-1) ---
A #highlight[highlighted] alksjdflk asdjlkfj alskdj word.

--- deco-tags-subscript-basic pdftags(ua-1) ---
CO#sub[2] emissions.
A2#sub[hex]

--- deco-tags-superscript-basic pdftags(ua-1) ---
CI#super[-] has a negative charge.

--- deco-tags-script-custom-baseline pdftags(ua-1) ---
...
--- deco-tags-emph-basic pdftags(ua-1) ---
Cats are _cute_ animals.

--- deco-tags-strong-basic pdftags(ua-1) ---
This *HERE* is important!

--- deco-tags-strong-and-em pdftags(ua-1) ---
_*strong and emph*_

--- deco-tags-strong-em-and-more-attrs pdftags(ua-1) ---
