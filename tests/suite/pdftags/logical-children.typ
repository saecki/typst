--- logical-children-tags-place-within-artifact pdftags(ua-1) ---
...
--- logical-children-tags-link-within-place-within-artifact pdftags(ua-1) ---
...
--- logical-children-tags-footnote-in-tiling pdftags(ua-1) ---
...
--- logical-children-tags-place-in-tiling pdftags(ua-1) ---
#rect(width: 90pt, height: 90pt, fill: tiling(size: (30pt, 30pt))[
  #place(float: true, top + right)[hi]
])

--- logical-children-tags-decorations-in-broken-grid-cell pdftags(ua-1) ---
...
--- logical-children-tags-hide-around-footnote pdftags(ua-1) ---
#hide[
...
--- logical-children-tags-hide-around-place pdftags(ua-1) ---
#hide[
...
--- logical-children-tags-underline-around-footnote pdftags(ua-1) ---
#underline[
  Some text #footnote[explanation].
]
...
--- logical-children-tags-underline-around-place paged pdftags(ua-1) ---
#underline[
  Some text #place(float: true, bottom + right)[explanation].
]
