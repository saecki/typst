...
--- table-tags-column-and-row-header pdftags(ua-1) ---
#table(
  columns: 3,
  table.header([H1], [H2], [H3]),
...
--- table-tags-missing-cells pdftags(ua-1) ---
#table(
  columns: 3,
...
--- table-tags-explicit-lines pdftags(ua-1) ---
#table(
  columns: 2,
...
--- table-tags-unset-bottom-line pdftags(ua-1) ---
#table(
  columns: 2,
  [a], [b],
  [c], [d],
...
--- table-tags-different-default-border pdftags(ua-1) ---
#table(
  columns: 2,
  stroke: red + 2pt,
...
--- table-tags-show-rule-error pdftags(ua-1) ---
...
--- table-tags-rowspan-split-1 pdftags(ua-1) ---
#set page(height: 6em)
#table(
  rows: (4em, auto, 4em),
  columns: 2,
...
--- table-tags-rowspan-split-2 pdftags(ua-1) ---
#set page(height: 6em)
#table(
  rows: (4em, auto, 4em),
  columns: 3,
...
--- table-tags-citation-in-repeated-header pdftags(ua-1) ---
...
--- table-tags-private-table-summary pdftags(ua-1) ---
...
--- table-tags-private-cell-kind pdftags(ua-1) ---
// Error: 13-25 unexpected argument: kind
#table.cell(kind: "nope")[A]

--- table-tags-unstable-functions pdftags(ua-1) ---
#pdf.table-summary(
