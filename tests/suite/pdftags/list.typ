...
--- list-tags-mixed-with-enum pdftags(ua-1) ---
- a
  + 1
- b
  + c
...
--- list-tags-wide-with-nested-list pdftags(ua-1) ---
- a
...
--- list-tags-complex-item-with-sub-list pdftags(ua-1) ---
...
--- list-tags-complex-item-with-nested-list pdftags(ua-1) ---
- #[
    #quote(block: true)[hi]
    #footnote[1].
    - a
...
--- list-tags-terms-basic pdftags(ua-1) ---
/ A: 1
/ B: 2
/ C: 3

--- list-tags-terms-basic-wide pdftags(ua-1) ---
/ A: 1
...
--- list-tags-terms-indented pdftags(ua-1) ---
/ A: 1
/ B: 2
  / B1: wow
  / B2: amazing

--- list-tags-terms-body-with-parbreak pdftags(ua-1) ---
/ A: 1 #parbreak() 232
/ B: 2

--- list-tags-terms-label-with-parbreak-error pdftags(ua-1) ---
