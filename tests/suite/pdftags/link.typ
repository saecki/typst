--- link-tags-heading-without-numbering pdftags(ua-1) ---
= Heading <heading>

#link(<heading>)[link to heading]

--- link-tags-heading-with-numbering pdftags(ua-1) ---
#set heading(numbering: "1.")
= Heading <heading>

#link(<heading>)[link to heading]

--- link-tags-non-refable-location pdftags(ua-1) ---
A random location <somewhere>

#link(<somewhere>)[link to somewhere]

--- link-tags-contact-prefix pdftags(ua-1) ---
#link("mailto:hello@typst.app")

#link("tel:123")

--- link-tags-position pdftags(ua-1) ---
#context link(here().position())[somewhere]

--- link-tags-link-in-artifact pdftags(ua-1) ---
...
--- link-tags-reference-in-artifact pdftags(ua-1) ---
...
--- link-tags-citation-in-artifact pdftags(ua-1) ---
...
--- link-tags-with-parbreak-error pdftags(ua-1) ---
