...
--- figure-tags-inline-equation-with-caption pdftags(ua-1) ---
#figure(
  math.equation(
...
--- figure-tags-block-equation-with-caption pdftags(ua-1) ---
#figure(
...
--- figure-tags-with-alt-flatten-content-basic pdftags(ua-1) ---
...
--- figure-tags-with-alt-flatten-content-complex pdftags(ua-1) ---
#figure(alt: "alt text")[
  #table(
    columns: 2,
...
--- figure-tags-alt-with-different-lang pdftags(ua-1) ---
#set text(lang: "de")
Ein Paragraph.
...
--- figure-tags-listing pdftags(ua-1) ---
#figure[
  ```rs
  fn main() {
      println!("Hello Typst!");
...
--- figure-tags-only-marked-content-missing-alt pdftags(ua-1) ---
...
--- figure-tags-additional-caption-inside-table pdftags(ua-1) ---
